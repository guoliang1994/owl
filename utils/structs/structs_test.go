...
func TestMap_MultipleCustomTag(t *testing.T) {
	...
	a, b := aStruct.Map(Underline), bStruct.Map(Underline)
...
func TestNestedNilPointer(t *testing.T) {
	...
	_ = Map(person, Underline)                  // Panics
	_ = Map(personWithDog, Underline)           // Panics
	_ = Map(personWithDogWithCollar, Underline) // Doesn't panic
}
